...
object Deps {
    ...
    object Android {
        private const val gradleVersion = "8.2.2"
        ...
        object Compose {
            ...
            const val constraintLayout = "androidx.constraintlayout:constraintlayout-compose:1.1.0-alpha13"
            ...
            const val swipe = "me.saket.swipe:swipe:1.1.1"
        }
    ...
    object Utils {
        ...
        const val threeTenAbp = "com.jakewharton.threetenabp:threetenabp:1.4.6"
        const val proguardSnippets = "com.github.yongjhih.android-proguards:android-proguards-all:-SNAPSHOT"

        const val threeTen = "org.threeten:threetenbp:1.6.7"

        const val coilVersion = "2.5.0"
        const val coil = "io.coil-kt:coil:$coilVersion"
        const val store = "com.dropbox.mobile.store:store4:4.0.6"
        ...
        const val exoPlayer = "com.google.android.exoplayer:exoplayer-core:2.19.1"
        const val exoPlayerOkhttp = "com.google.android.exoplayer:extension-okhttp:2.19.1"
        const val exoPlayerFlac = "com.github.alashow.ExoPlayer-Extensions:extension-flac:v2.19.1"

        const val qonversion = "io.qonversion.android.sdk:sdk:6.5.1"
    }
    ...
    object Retrofit {
        ...
        const val kotlinSerializerConverter = "com.jakewharton.retrofit:retrofit2-kotlinx-serialization-converter:1.0.0"
    }
